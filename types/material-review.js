 ...
 * 材料分类类型
 */
export var MaterialCategory;
(function (MaterialCategory) {
    MaterialCategory["IDENTITY"] = "identity";
    MaterialCategory["MEDICAL"] = "medical";
    MaterialCategory["ACCIDENT"] = "accident";
    MaterialCategory["INCOME"] = "income";
 ...
 * @returns 材料分类
 */
export function getMaterialCategory(materialName) {
 ...
 * @returns 视图项
 */
export function toMaterialViewItem(file) {
 ...
 * @returns 分组结果（按时间倒序）
 */
export function groupMaterialsByTime(materials) {
    // 按时间倒序排序
 ...
 * @returns 排序后的列表
 */
export function sortMaterialsByTime(materials, ascending = false) {
 ...
 * @returns 状态标签和颜色
 */
export function getMaterialStatusInfo(material) {
...
//# sourceMappingURL=material-review.js.map